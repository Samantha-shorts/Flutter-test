            ...
            statusObservation = item.observe(\.status) { [weak self] item, _ in
                ...
                case .failed:
                    ...
                    if let nsError = item.error as? NSError {
                        ...
                        errorUserInfo = nsError.userInfo.compactMapValues { value in
                    ...
                    self?.sendEvent(.error, ["error": item.error?.localizedDescription as Any, "invalid": invalid, "code": errorCode as Any, "userInfo": errorUserInfo as Any])
                case .readyToPlay:
                    self?.readyToPlay()
                default:
                    break
